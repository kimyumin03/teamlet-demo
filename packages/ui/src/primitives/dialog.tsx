...
/**
 * Dialog (docs/05 §10, §7-3 모달 표준) — shadow-lg + 백드롭.
 * 모달 진입 모션: opacity + scale(0.96→1), 200ms ease-out (docs/05 §8).
 */
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-slate-900/40 transition-opacity duration-200 data-[state=closed]:opacity-0",
      className,
    )}
    {...props}
  />
